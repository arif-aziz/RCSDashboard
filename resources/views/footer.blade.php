...
<script src="/rcsdashboard/js/chart/chart.bundle.js"></script>
<script src="/rcsdashboard/js/chart/chartjs-plugin-annotation.js"></script>
<script src="/rcsdashboard/js/chart/chartjs-plugin-annotation.min.js"></script>
<script src="/rcsdashboard/js/chart/utils.js"></script>
...
<!-- RCSDashboard -->
<script src="/rcsdashboard/js/pages/distributionlevel.js"></script>
<script>
  $(function () {
    $('#tbl-raw-prev').DataTable({
      'paging'      : true,
      'lengthChange': true,
      'searching'   : true,
      'ordering'    : true,
...
null;
/*
$('#frm-fileraw').on('submit', function(e) {
  e.preventDefault();  
...
function sendAJAX(timestamp) {
    var extension = $('#inp-fileraw').val().split('.').pop().toLowerCase();
